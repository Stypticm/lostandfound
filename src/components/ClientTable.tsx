...
const ClientTable = ({ foundItems, lostItems }: ClientTableProps) => {
    ...
    const filteredItems = allItems.filter(item => item.title.toLowerCase().includes(normalizedSearch))
                ...
                <>
                    <section className="flex flex-col">
                        <h2 className="text-2xl font-bold text-center">
                            {t('recentlyFound')} — <br /><Link href="/found" className="underline text-primary">{t('seeAll')}</Link>
                        </h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-center">
                            {t('recentlyLost')} — <br /><Link href="/lost" className="underline text-primary">{t('seeAll')}</Link>
                        </h2>
